...
export const SET_MINIMUM_PRICE_INIT = "SET_MINIMUM_PRICE_INIT";
export const SET_MINIMUM_PRICE_SUCCESS = "SET_MINIMUM_PRICE_SUCCESS";
export const SET_MINIMUM_PRICE_ERROR = "SET_MINIMUM_PRICE_ERROR";

export const GET_MINIMUM_PRICE_INIT = "GET_MINIMUM_PRICE_INIT";
export const GET_MINIMUM_PRICE_SUCCESS = "GET_MINIMUM_PRICE_SUCCESS";
export const GET_MINIMUM_PRICE_ERROR = "GET_MINIMUM_PRICE_ERROR";
//plopImport
